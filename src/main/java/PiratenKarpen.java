...
public class PiratenKarpen {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0 || args.length == 1){
            logger.info("No Arguments Inputted, Using Default Values");
        ...
        if (args.length == 2){
            logger.info("Strategies Applied, Using Default Number Of Games (42)");
        ...
        if (args.length == 3){
            logger.info("Strategies And # Of Games Applied");
        ...
        logger.info("Number Of Games Played In Total: " + game.getGamesPlayed());
        logger.info("Player 1 Games Won: " + game.getP1Wins());
        logger.info("Player 2 Games Won: " + game.getP2Wins());
        logger.info("Ties Encountered: " + game.getTies() + "\n");
